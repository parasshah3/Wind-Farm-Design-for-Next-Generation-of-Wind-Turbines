    ...
    **Uses a persistent Excel session for efficiency.**
    ...
    try:
        ...
        for generation in range(1, max_generations + 1):
            ...
            # **Step 4: Generate Next Generation with Mutation**
            ...
            # **Step 5: Evaluate Fitness of New Population (with caching)**
            ...
            for layout in new_population:
                ...
                if layout_tuple in lcoe_cache:
                    ...
                    print(f"layout already evaluated, using cached LCOE: {lcoe_cache[layout_tuple]:.2f}")
                else:
            ...
            # **Step 6: Select the Fittest Individual**

...
dij_values = np.linspace(0, 2 * dij_no_shadow, 1000)  # Extend beyond the no-shadowing threshold
...
for d_ij in dij_values:
    ...
    v_j, partial_shadowing, complete_shadowing, no_shadowing = fd.multiple_wake_model_ij(v_i, r_0, Ct, x_ij, z, z_0, d_ij)

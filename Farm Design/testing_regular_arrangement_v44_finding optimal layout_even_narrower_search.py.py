...
from farm_design_functions_v28 import evaluate_all_arrangements
...
for idx, (layout, lcoe, a, b, theta) in enumerate(sorted_results[:5]):
    print(f"Rank {idx+1}: LCOE = {lcoe:.9f} £/MWhr | Turbines = {len(layout)} | a = {a:.8f} m, b = {b:.8f} m, θ = {theta:.8f}°")


print(f"Best LCOE: {best_LCOE:.9f} £/MWhr")

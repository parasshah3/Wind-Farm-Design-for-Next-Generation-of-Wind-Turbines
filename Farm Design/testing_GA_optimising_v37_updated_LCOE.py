...
from farm_design_functions_v23 import genetic_algorithm

# Define file path to BEM spreadsheet
file_path = "/Users/paras/Desktop/3YP Python Scripts/Farm Design/Wind Farms .csv Files/25MW_SeventhIteration.xlsm"
sheet_name = "WindDist"
...
num_turbines_range = (10, 80)  # Min & max turbines
...
for i, (layout, lcoe, gen) in enumerate(best_layouts, 1):
    print(f"Rank {i}: LCOE = {lcoe:.4f} £/MWhr (Generation {gen}) | {len(layout)} turbines")

# Print final best layout details
print("\nFinal Best Wind Farm Layout:")
print(f"LCOE: {final_best_LCOE:.4f} £/MWhr")
